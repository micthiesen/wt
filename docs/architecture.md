...
and cursor redraws.
wt launches and resumes Codex without CLI configuration or feature overrides,
including for main and manager slots. Codex reads terminal preferences from its
