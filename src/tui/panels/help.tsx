...
const KEY_BLOCKS: Block[] = [
  ...
  },
  {
    ...
    note: "Tmux-hosted task inbox: left = tasks, right = live session. Typing always goes to the session; drive wt with the \u2318 layer (Alacritty-translated, works from either pane). For rare classic actions: \u2318H to focus the tasks pane, type the letter, Esc back. `wt classic` opens the three-pane TUI.",
    items: [
      ...
      { key: "\u2318H / Esc", label: "focus the tasks pane / bounce back to the session" },
