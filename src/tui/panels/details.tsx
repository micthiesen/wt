...
import type { RemovedWorktree, StackManifest } from "../../core/wtstate.ts";
...
function removedPrBadge(state: string | undefined): {
  glyph: string;
  fg: string;
  label: string;
} | null {
 ...
 */
function RemovedBody({ entry }: { entry: RemovedWorktree }) {
